...
export class ReadingListController {
  ...
  async markAsFinished(@Param() params: {id: string}, @Body() body: {finishedDate: string}): Promise<void> {
    return await this.readingList.markAsFinished(params.id, body.finishedDate);
  }
}
